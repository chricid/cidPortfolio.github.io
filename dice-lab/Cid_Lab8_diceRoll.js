...
//adds and subtracts balance and declares who won
function whoWon() {
    ...
    finalBalance.innerHTML = "Your final Balance is: $" + balance;
}
...
//runs on click with button
function letsPlay(){

 //input number of rolls
  numRolls = prompt("Enter how many times you want to rolls the dice:");
